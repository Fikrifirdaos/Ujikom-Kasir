                                ...
                                <div class="modal fade" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('stock.nambah', $stock->id) }}"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('stock.update', $stock->id) }}"
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="name_produk">Nama Produk<span
                                                                class="text-danger">*</span></label>
                                                        <input id="name_produk" class="form-control" name="name_produk"
                                                            tabindex="1" value="{{ $stock->name_produk }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('stock.store') }}" class="needs-validation" novalidate="">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="name_produk">Nama Produk<span class="text-danger">*</span></label>
                            <input id="name_produk" class="form-control" name="name_produk" tabindex="1"
                                type="text" required autofocus>
                            <div class="invalid-feedback">
                                Silahkan isi nama produk
                            </div>
